...
export default function Login() {
    ...
    // State to hold users without persisting to localStorage
                ...
                <div className="overlay-container">
                    <div className="overlay">
                        <div className="overlay-left">
                            ...
                            <button onClick={handleSignInClick} className="login-btn" style={{ border: "3px solid #ccc" }}>
                                Sign In
                            </button>
                        </div>
                        <div className="overlay-right">
                            ...
                            <button onClick={handleSignUpClick} className="login-btn" style={{ border: "3px solid #ccc" }}>
                                Sign Up
                            </button>
                        </div>
                    </div>
